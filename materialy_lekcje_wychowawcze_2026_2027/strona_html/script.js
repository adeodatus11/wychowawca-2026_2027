const LESSONS = [
  {
    ...
    "schedule": [
      [
        "0-3 min",
        "Start",
        "Pytanie: gdzie uczeń szuka informacji, gdy nie wie, co zrobić?"
      ],
      [
        "3-14 min",
        "Spacer nawigacyjny",
        "Krótka trasa: wejście/portiernia, sekretariat, tablice, pedagog/psycholog, biblioteka, pracownie."
      ],
      [
        "14-22 min",
        "Nawigacja cyfrowa",
        "Pokaz: EduPage, Szkoła Mistrzów, Facebook, Dziennik VULCAN."
      ],
      [
        "22-27 min",
        "Mini-zadanie",
        "Uczniowie w parach układają 3 scenki: gdzie idę / do kogo piszę / co sprawdzam w dzienniku."
      ],
      [
        "27-30 min",
        "Domknięcie",
        "Każdy zapisuje jedną rzecz, którą sprawdzi dziś w domu z rodzicem/opiekunem."
      ]
    ],
    "key_points": [
    ...
    "slides": [
      [
        "Po co ta lekcja?",
        [
          "Dziś uczymy się poruszać po szkole i po jej kanałach informacji.",
          "Cel: wiedzieć, gdzie i do kogo iść, zanim pojawi się problem."
        ]
      ],
      [
        "Najważniejsze miejsca",
        [
          "Wejście i portiernia",
          "Sekretariat uczniowski",
          "Pedagog, psycholog, pomoc PP",
          "Biblioteka i tablice informacyjne",
          "Pracownie zawodowe i sale klasowe"
        ]
      ],
      [
        "Strona szkoły",
        [
          "zsz5.edupage.org",
          "statut, dokumenty, komunikaty",
          "zakładki dla uczniów i rodziców"
        ]
      ],
      [
        "Szkoła Mistrzów",
        [
          "szkolamistrzow.info",
          "oferta zawodowa",
          "dualny charakter kształcenia"
        ]
      ],
      [
        "Facebook szkoły",
        [
          "bieżące życie szkoły",
          "wydarzenia i sukcesy",
          "nie zastępuje oficjalnych komunikatów"
        ]
      ],
      [
        "Dziennik VULCAN",
        [
          "oceny, frekwencja, wiadomości",
          "usprawiedliwienia i kontakt z rodzicem",
          "uczeń i rodzic potrzebują własnego dostępu"
        ]
      ],
      [
        "Szybka mapa decyzji",
        [
          "Nie wiem, gdzie iść: wychowawca",
          "Nie mam dostępu do dziennika: wychowawca/procedura szkoły",
          "Jestem chory: rodzic i usprawiedliwienie",
          "Mam kryzys: pedagog/psycholog"
        ]
      ]
    ]
  },
  {
    ...
    "schedule": [
      [
        "0-4 min",
        "Start",
        "Dlaczego szkoła nie może działać na nieaktualnym numerze telefonu?"
      ],
      [
        "4-10 min",
        "Kategorie danych",
        "Uczeń, adres, rodzice/opiekunowie, kontakty, dane do dokumentacji szkolnej."
      ],
      [
        "10-18 min",
        "Lista kontrolna",
        "Uczniowie zaznaczają, co mają sprawdzić w domu; bez wpisywania danych na forum klasy."
      ],
      [
        "18-25 min",
        "Bezpieczeństwo danych",
        "Co wolno wysłać, czego nie wolno publikować, komu przekazujemy dokumenty."
      ],
      [
        "25-30 min",
        "Zadanie domowe",
        "Uczeń ustala z rodzicem/opiekunem, co trzeba uzupełnić i do kiedy."
      ]
    ],
    "key_points": [
    ...
    "slides": [
      [
        "Po co kartoteka?",
        [
          "kontakt w pilnej sytuacji",
          "prawidłowe dokumenty szkolne",
          "frekwencja i usprawiedliwienia",
          "komunikacja z rodzicem/opiekunem"
        ]
      ],
      [
        "Kategorie danych",
      ...
      [
        ...
        [
          "imię i nazwisko",
          "adres, jeśli wymagany",
          "telefon",
          "e-mail do konta dziennika",
          "aktualność kontaktu"
        ]
      ],
      [
        "Czego nie robimy",
        [
          "nie czytamy danych na forum",
          "nie wpisujemy danych w publiczny formularz",
          "nie wysyłamy dokumentów na grupę klasy",
          "nie pokazujemy kartoteki na projektorze"
        ]
      ],
      [
        "Zadanie",
  ...
  },
  {
    ...
    "schedule": [
      [
        "0-4 min",
        "Start",
        "Gdzie szukać zasad, gdy ktoś mówi: 'tak jest w statucie'?"
      ],
      [
        "4-9 min",
        "Jak znaleźć dokument",
        "Pokaz strony szkoły i zakładki Statut."
      ],
      [
        "9-18 min",
        "Co reguluje statut",
        "Prawa, obowiązki, ocenianie, zachowanie, frekwencja, praktyki, pomoc."
      ],
      [
        "18-26 min",
        "Praca na fragmentach",
        "Grupy rozwiązują 3 przypadki: nieobecność, praktyka, nieklasyfikowanie."
      ],
      [
        "26-30 min",
        "Podsumowanie",
        "Uczeń zapisuje: jeden paragraf, który realnie go dotyczy."
      ]
    ],
    "key_points": [
    ...
    "slides": [
      [
        "Statut to instrukcja szkoły",
        [
          "nie tylko dokument prawny",
          "zasady wspólne dla uczniów i nauczycieli",
          "punkt odniesienia w sporach"
        ]
      ],
      [
        "Gdzie go znaleźć",
        [
          "zsz5.edupage.org",
          "menu: Statut",
          "pracujemy na aktualnym pliku ze strony"
        ]
      ],
      [
        "Co reguluje",
      ...
      [
        "Dlaczego frekwencja jest w statucie",
        [
          "usprawiedliwienia",
          "ostrzeżenia i nagany",
          "klasyfikacja",
          "promocja",
          "praktyki zawodowe"
        ]
  ...
  },
  {
    ...
    "schedule": [
      [
        "0-5 min",
        "Start",
        "Frekwencja to nie ocena z charakteru, tylko informacja o ryzyku."
      ],
      [
        "5-12 min",
        "Konkrety prawne i szkolne",
        "50% w miesiącu, nieklasyfikowanie, progi statutu ZSZ5."
      ],
      [
        "12-20 min",
        "Analiza przypadków",
        "Trzy fikcyjne sytuacje: choroba, spóźnienia, unikanie praktyk."
      ],
      [
        "20-27 min",
        "Plan naprawy",
        "Uczeń wybiera jeden mikro-krok na 7 dni."
      ],
      [
        "27-30 min",
        "Zamknięcie",
        "Kiedy proszę o pomoc i kogo informuję?"
      ]
    ],
    "key_points": [
    ...
    "slides": [
      [
        "Frekwencja to sygnał",
        [
          "nie ranking",
          "nie etykieta",
          "informacja o ryzyku",
          "punkt startu do działania"
        ]
      ],
      [
        "Dlaczego ważna",
      ...
      [
        ...
        [
          "50% nieusprawiedliwionej nieobecności w miesiącu",
          "ponad połowa nieobecności na zajęciach może oznaczać brak klasyfikacji",
          "statutowe reakcje szkoły"
        ]
      ],
      [
        "Co robię po nieobecności",
        [
          "usprawiedliwienie w terminie",
  ...
  {
    "id": "04",
    "slug": "04_reforma26_kompas_jutra",
    "title": "Reforma26 i Kompas Jutra: szkoła wymagająca, wspierająca i przyjazna",
    "group": "Wszystkie klasy",
    "men": "Wspieranie szkół we wdrażaniu zmian wynikających z Reformy26. Kompas Jutra.",
    "purpose": "Uczeń rozumie, że reforma nie jest hasłem ministerialnym, tylko zmianą sposobu uczenia się: więcej sensu, wymagań, wsparcia i informacji zwrotnej.",
    "outcomes": [
      "szkoła może jednocześnie wymagać i wspierać",
      "uczeń ma wpływ na sposób uczenia się klasy",
      "informacja zwrotna pomaga poprawić pracę"
    ],
    "materials": [
    ...
    "schedule": [
      [
        "0-4 min",
        "Start",
        "Jedno pytanie otwierające i szybka diagnoza skojarzeń."
      ],
      [
        "4-10 min",
        "Priorytet MEN po ludzku",
        "Nauczyciel tłumaczy sens priorytetu na przykład z życia szkoły."
      ],
      [
        "10-21 min",
        "Ćwiczenie główne",
      ...
      [
        "21-27 min",
        "Przeniesienie na klasę",
        "Co z tego wynika dla naszej frekwencji, relacji, praktyk lub bezpieczeństwa?"
      ],
      [
        "27-30 min",
        "Zamknięcie",
        "Exit ticket: jedna decyzja, jedna prośba, jedno pytanie."
      ]
    ],
    "key_points": [
      "wymagania",
    ...
    "activity": "Burza faktów: co w naszej klasie pomaga się uczyć, co przeszkadza, czego potrzebujemy od siebie.",
    ...
    "slides": [
      [
        ...
        [
          ...
          "30 minut rozmowy i konkretu wychowawczego"
        ]
      ],
      [
        "Priorytet MEN",
      ...
      [
        "Połączenie z frekwencją",
        [
          "obecność daje kontakt",
          "kontakt daje wsparcie",
          "wsparcie pomaga utrzymać naukę i praktyki"
        ]
      ],
      [
        "Wyjście z lekcji",
  ...
  {
    "id": "05",
    "slug": "05_odpornosc_spoleczna_bezpieczenstwo",
    "title": "Odporność społeczna: patriotyzm, obywatelskość i bezpieczeństwo na co dzień",
    "group": "Wszystkie klasy",
    "men": "Szkoła miejscem budowania odporności społecznej; postawy patriotyczne, obywatelskie, prospołeczne i odpowiedzialność za bezpieczeństwo.",
    "purpose": "Uczeń rozumie, że odporność społeczna zaczyna się od codziennych zachowań: reagowania, informowania, dbania o innych i przestrzegania procedur.",
    "outcomes": [
      "rozpoznaje sytuacje wymagające reakcji dorosłych",
      "odróżnia donoszenie od odpowiedzialnego zgłoszenia",
      "wiąże patriotyzm z troską o wspólnotę"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Drabina reakcji: uczniowie ustawiają sytuacje od 'rozwiązuję sam' do 'natychmiast zgłaszam dorosłemu'.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
  ...
  {
    "id": "06",
    "slug": "06_edukacja_zdrowotna",
    "title": "Edukacja zdrowotna: sen, ruch, jedzenie, pierwsza pomoc i frekwencja",
    "group": "Wszystkie klasy",
    "men": "Edukacja zdrowotna; zdrowy styl życia, aktywność ruchowa, zachowania prozdrowotne i pierwsza pomoc.",
    "purpose": "Uczeń łączy zdrowie z obecnością w szkole, gotowością do pracy i bezpieczeństwem własnym oraz innych.",
    "outcomes": [
      "wskazuje jeden nawyk zdrowotny wpływający na frekwencję",
      "zna podstawowy schemat reagowania w sytuacji zagrożenia",
      "rozumie, że zdrowie to też proszenie o pomoc"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Audit dnia: uczniowie wybierają jeden element do poprawy przez tydzień: sen, śniadanie, ruch, nawodnienie, ograniczenie ekranu przed snem.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
  ...
  {
    "id": "07",
    "slug": "07_higiena_cyfrowa_ai_zpe",
    "title": "Higiena cyfrowa, AI i krytyczne myślenie",
    "group": "Wszystkie klasy",
    "men": "Higiena cyfrowa i aktywność offline; bezpieczeństwo w sieci; krytyczna analiza informacji; odpowiedzialne wykorzystanie AI; ZPE.",
    "purpose": "Uczeń potrafi nazwać koszt nadmiaru telefonu i wie, jak odpowiedzialnie korzystać z AI bez oddawania swoich danych i myślenia.",
    "outcomes": [
      "odróżnia pomoc AI od zastępowania własnej pracy",
      "zna zasadę niewpisywania danych osobowych do publicznych narzędzi",
      "umie sprawdzić informację w co najmniej dwóch źródłach"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Test informacji: uczniowie dostają krótką tezę i planują, jak ją zweryfikować bez kopiowania pierwszego wyniku.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
  ...
  {
    "id": "08",
    "slug": "08_potrzeby_ucznia_wspolpraca_z_rodzicami",
    "title": "Moje potrzeby w szkole: jak prosić o wsparcie i współpracować z rodzicem",
    "group": "Wszystkie klasy",
    "men": "Rozpoznawanie potrzeb dzieci i młodzieży; współpraca z rodzicami; pomoc psychologiczno-pedagogiczna i wychowawcza.",
    "purpose": "Uczeń wie, że trudność szkolna powinna uruchomić rozmowę i wsparcie, a nie samotne znikanie z lekcji.",
    "outcomes": [
      "nazywa szkolne sytuacje, w których warto poprosić o pomoc",
      "wie, że pomoc PP jest dobrowolna i nieodpłatna",
      "potrafi przygotować krótką wiadomość do wychowawcy"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Trzy zdania do wychowawcy: 'Mam trudność z...', 'Potrzebuję...', 'Mogę zrobić pierwszy krok...'.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
  ...
  {
    "id": "09",
    "slug": "09_uzaleznienia_przemoc_kryzys",
    "title": "Uzależnienia behawioralne, przemoc rówieśnicza i kryzys psychiczny",
    "group": "Wszystkie klasy",
    "men": "Profilaktyka uzależnień behawioralnych i przemocy rówieśniczej; zdrowie psychiczne; reagowanie w kryzysach.",
    "purpose": "Uczeń rozpoznaje sygnały ryzyka i wie, że szybkie zgłoszenie przemocy lub kryzysu jest działaniem ochronnym.",
    "outcomes": [
      "odróżnia konflikt od przemocy",
      "wskazuje przykłady uzależnień behawioralnych",
      "zna szkolną ścieżkę zgłoszenia kryzysu"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Sygnały i reakcje: uczniowie przypisują sytuacje do reakcji: rozmowa, wsparcie rówieśnicze, wychowawca, pedagog/psycholog, natychmiastowa pomoc dorosłego.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
  ...
  {
    "id": "10",
    "slug": "10_doradztwo_zawodowe_ksztalcenie_zawodowe",
    "title": "Decyzje edukacyjno-zawodowe: zawód, praktyki i rynek pracy",
    "group": "Wszystkie klasy",
    "men": "Świadome decyzje edukacyjno-zawodowe; doradztwo zawodowe; promocja kształcenia zawodowego; nowa oferta szkół branżowych i techników.",
    "purpose": "Uczeń widzi związek między frekwencją, praktyką, relacją z pracodawcą i przyszłą ścieżką zawodową.",
    "outcomes": [
      "łączy obecność z nabywaniem kompetencji zawodowych",
      "wskazuje źródła informacji o zawodach w ZSZ5",
      "potrafi nazwać jedną kompetencję do rozwijania w semestrze"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Mapa zawodu: uczniowie wybierają kompetencję zawodową i dopisują, gdzie ją ćwiczą: szkoła, praktyka, dom, projekt.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
  ...
  {
    "id": "11",
    "slug": "11_praca_projektowa_ocenianie_ksztaltujace",
    "title": "Ciekawość, projekt i informacja zwrotna",
    "group": "Wszystkie klasy",
    "men": "Ciekawość i aktywność poznawcza; interdyscyplinarność; praca projektowa; ocenianie kształtujące i informacja zwrotna.",
    "purpose": "Uczeń rozumie, że dobra informacja zwrotna i praca projektowa pomagają uczyć się także po błędzie.",
    "outcomes": [
      "formułuje prosty cel projektu",
      "odróżnia ocenę od informacji zwrotnej",
      "umie dać koledze informację: plus, pytanie, propozycja poprawy"
    ],
    "materials": [
      "tablica lub wspólny dokument bez danych osobowych",
      "karta pracy z pytaniami do refleksji",
    ...
    "activity": "Mini-projekt klasy: wybór problemu szkolnego, szybki cel, kryteria sukcesu i jedna informacja zwrotna w parze.",
    "privacy": "Uczniowie mogą pracować na przykładach fikcyjnych. Nie ujawniamy danych zdrowotnych, rodzinnych, ocen, sytuacji kryzysowych ani nazwisk.",
    "assessment": "Krótka karta wyjścia: 'rozumiem...', 'mogę zrobić...', 'potrzebuję zapytać...'.",
    "slides": [
      [
